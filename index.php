...
if (!empty($_POST))
{
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					<h4>My Links</h4>
					<p>
						<a href="http://xlong88.github.io">Blog</a><br/>
						<a href="https://github.com/xlong88">Github</a><br/>
            <a href="https://scholar.google.com/citations?user=qtAikfAAAAAJ&hl=en">Google Scholar Profile</a><br/>
				...
				<div class="col-lg-4">
					...
					<p>This cute theme was downloaded from <a href="http://blacktie.co/2014/01/stanley-freelancer-theme/">stanley-freelancer-theme</a>.</p>
				</div><!-- /col-lg-4 -->
    ...
    <?php
    if(!empty($_POST) && (array_key_exists('pub',$_POST) || array_key_exists('reading',$_POST)))
    {
