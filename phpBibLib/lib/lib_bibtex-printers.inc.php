...
abstract class BasePrinter {
	...
	function CitationImplementUrlStr($entry) {
		global $Path;
		//$str = (isset($entry['implementationurl ']) ? ' <a href="' . $entry['implementationurl '] . '" class="bibtex-implement-url">(Implementation)</a>' : '' );
		$str = (isset($entry['implementationurl ']) ? ' <a href="' . $entry['implementationurl '] . '" class="bibtex-implement-url"><img src="'.$Path['img-icons'].$this->icons['impl'].'" alt="implementation" /></a>' : '' );
		return $str;
	}
...
require_once($Path['lib-bibtex'] . 'lib_bibtex-printers-abbrv.inc.php');
require_once($Path['lib-bibtex'] . 'lib_bibtex-printers-natbib.inc.php');
require_once($Path['lib-bibtex'] . 'lib_bibtex-printers-numeric.inc.php');
?>